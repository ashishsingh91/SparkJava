...
public class SparkMapToPair {
	...
	public static void main(String[] args) {
		JavaSparkContext javaSparkContext = SparkUtility.getJavaSparkContext(SparkConstant.MASTER_LOCAL, SparkConstant.APP_NAME+"MAPTOPAIR");
		...
		mapToPair.foreach(System.out::println);
