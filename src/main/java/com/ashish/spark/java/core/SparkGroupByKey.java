...
public class SparkGroupByKey {
	...
	public static void main(String[] args) {
		JavaSparkContext javaSparkContext = SparkUtility.getJavaSparkContext(SparkConstant.MASTER_LOCAL, SparkConstant.APP_NAME+"GROUPBYKEY");
		...
		mapToPair.groupByKey().foreach(System.out::println);;
	}
